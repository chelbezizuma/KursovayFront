...
public class FragmentRaspisanie5 extends Fragment {

    static ArrayList<DescriptionOfItemInList> descriptionOfItemInLists;

    public static FragmentRaspisanie5 newInstance(ArrayList<DescriptionOfItemInList> descriptionOfItem) {
        descriptionOfItemInLists = descriptionOfItem;
        Bundle args = new Bundle();
        FragmentRaspisanie5 fragment = new FragmentRaspisanie5();
        fragment.setArguments(args);
        return fragment;
    }


    public FragmentRaspisanie5() {
