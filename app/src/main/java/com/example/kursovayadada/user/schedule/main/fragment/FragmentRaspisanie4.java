...
public class FragmentRaspisanie4 extends Fragment {

    static ArrayList<DescriptionOfItemInList> descriptionOfItemInLists;

    public static FragmentRaspisanie4 newInstance(ArrayList<DescriptionOfItemInList> descriptionOfItem) {
        descriptionOfItemInLists = descriptionOfItem;
        Bundle args = new Bundle();
        FragmentRaspisanie4 fragment = new FragmentRaspisanie4();
        fragment.setArguments(args);
        return fragment;
    }


    public FragmentRaspisanie4() {
