...
public class FragmentRaspisanie3 extends Fragment {

    static ArrayList<DescriptionOfItemInList> descriptionOfItemInLists;

    public static FragmentRaspisanie3 newInstance(ArrayList<DescriptionOfItemInList> descriptionOfItem) {
        descriptionOfItemInLists = descriptionOfItem;
        Bundle args = new Bundle();
        FragmentRaspisanie3 fragment = new FragmentRaspisanie3();
        fragment.setArguments(args);
        return fragment;
    }


    public FragmentRaspisanie3() {
