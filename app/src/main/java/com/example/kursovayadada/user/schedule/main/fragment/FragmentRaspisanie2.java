...
public class FragmentRaspisanie2 extends Fragment {

    static ArrayList<DescriptionOfItemInList> descriptionOfItemInLists;

    public static FragmentRaspisanie2 newInstance(ArrayList<DescriptionOfItemInList> descriptionOfItem) {
        descriptionOfItemInLists = descriptionOfItem;
        Bundle args = new Bundle();
        FragmentRaspisanie2 fragment = new FragmentRaspisanie2();
        fragment.setArguments(args);
        return fragment;
    }


    public FragmentRaspisanie2() {
